...
add(['WILDBITS | K2 + Jr2 | QUICK REFERENCE | 23 September 2026'],'E0E0E0',True,True)
...
c=canvas.Canvas(str(P/'wildbits-rc17-memory-map.pdf'),pagesize=(612,792))
c.setTitle('WILDBITS | K2 + Jr2 | QUICK REFERENCE | 23 September 2026')
